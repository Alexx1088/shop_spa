        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <form action="{{route('product.update', $product->id)}}" method="post">
                    ...
                    <div class="form-group">
                        <input type="text" name="content" value="{{ $product->content }}" class="form-control" placeholder="Контент">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <div class="input-group">
                            <div class="custom-file">
                                <input name="preview_image" type="file" value="{{ $product->preview_image }}" class="custom-file-input" id="exampleInputFile">
                            ...
                            <div class="form-group">
                                <select class="tags" name="tags[]"  multiple="multiple" data-placeholder="Выберите тэг"
                                        style="width: 100%;">
                                    @foreach($tags as $tag)
